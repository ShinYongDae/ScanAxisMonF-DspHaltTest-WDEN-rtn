...
#include "../dsp281x_include/DSP281x_Device.h"     // DSP281x Headerfile Include File
#include "../dsp281x_include/DSP281x_Examples.h"   // DSP281x Examples Include File
...
{   
    EALLOW;   
    SysCtrlRegs.WDCR= 0x002F;   // 30MHz/512/64/256 = 3.576279Hz ( 0.28 [Sec] )
    EDIS;   
}   
