...
#include "../dsp281x_include/DSP281x_Device.h"     // DSP28 Headerfile Include File
#include "../dsp281x_include/DSP281x_Examples.h"   // DSP28 Examples Include File
...
/* Configure bit timing parameters */
    ...
    ECanaRegs.CANBTC.bit.BRPREG = 9;    //1MHz
	//ECanaRegs.CANBTC.bit.BRPREG = 19;   //500k
